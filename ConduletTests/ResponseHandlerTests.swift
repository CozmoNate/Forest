    ...
    override func spec() {
        ...
        describe("ProtobufContentHandler") {
            ...
            it("can handle Proto message content") {
                ...
                let handler = ProtobufContentHandler(decodingOptions: JSONDecodingOptions()) { (object, response) in
            ...
            it("fails on invalid content type") {
                ...
                let handler = ProtobufContentHandler<Google_Protobuf_StringValue>(decodingOptions: JSONDecodingOptions(), completion: nil)
                do {
                    try handler.handle(content: ServiceTaskContent.data(Data()), response: response)
                }
                catch {
